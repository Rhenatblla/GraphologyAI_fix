    ...
    <main className="relative min-h-screen pt-20 overflow-hidden">
      ...
      <section className="bg-white/80 backdrop-blur-sm text-gray-800 py-20 px-6">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="italic text-gray-700 text-xl font-medium leading-relaxed relative z-10">
                  "Grapholyze hadir dari keyakinan bahwa tulisan tangan menyimpan jejak kepribadian unik setiap individu. Dengan memadukan grafologi tradisional dan teknologi AI modern, kami ingin membuat analisis kepribadian menjadi lebih
                  mudah, cepat, dan dapat diakses oleh semua orang."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="mb-24 py-16 border-t border-gray-100 relative">
            ...
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-4xl font-bold text-indigo-900 mb-12 text-center">
              Tim Grapholyze
            </motion.h2>
            <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-center text-gray-600 mb-16 text-lg max-w-3xl mx-auto">
          ...
          {/* Teknologi Kami */}
          <div className="py-16">
            <motion.h2 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-4xl font-bold text-indigo-900 mb-12 text-center">
              Teknologi Kami
            </motion.h2>
            <p className="text-center text-gray-600 mb-16 text-lg max-w-3xl mx-auto">Menggunakan teknologi AI dan machine learning terdepan untuk memberikan hasil analisis yang akurat dan mendalam.</p>
            ...
            <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }} className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                ...
                <motion.div variants={fadeInUp} key={i} whileHover={{ y: -10 }} className="flex flex-col items-center text-center p-8 rounded-3xl bg-white border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-300">
      ...
      <section className="bg-gradient-to-b from-slate-900 to-indigo-950 py-24 px-6 text-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <motion.h2 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-4xl font-bold mb-16 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-200 to-purple-200">
            Visi & Misi
          </motion.h2>

          <div className="grid md:grid-cols-2 gap-12">
            {/* Visi */}
            <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-white/10 backdrop-blur-md rounded-3xl p-10 border border-white/10 hover:border-white/20 transition-colors">
      ...
      <section className="bg-gradient-to-r from-indigo-600 to-purple-700 text-white py-24 px-6 text-center relative overflow-hidden">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="relative z-10">
          ...
          <button onClick={() => router.push("/user/homeanalisis")} className="bg-yellow-400 text-gray-900 font-bold px-10 py-4 rounded-full hover:bg-yellow-300 transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105">
